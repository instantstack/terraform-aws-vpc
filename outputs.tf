...
output "vpc_id" {
  ...
  value       = var.existent_vpc == true ? var.vpc_id : try(aws_vpc.this[0].id, null)
}
...
output "vpc_cidr_block" {
  ...
  value       = var.existent_vpc == true ? data.aws_vpc.existent.0.cidr_block : try(aws_vpc.this[0].cidr_block, null)
}
...
output "public_subnets" {
  ...
  value       = var.existent_vpc == true ? var.public_subnet_ids : aws_subnet.public[*].id
}
...
output "private_subnets" {
  ...
  value       = var.existent_vpc == true ? var.private_subnet_ids : aws_subnet.private[*].id
}
